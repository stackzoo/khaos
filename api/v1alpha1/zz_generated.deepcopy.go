...
func (in *CordonNodeSpec) DeepCopyInto(out *CordonNodeSpec) {
	*out = *in
	if in.NodesToCordon != nil {
		in, out := &in.NodesToCordon, &out.NodesToCordon
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
