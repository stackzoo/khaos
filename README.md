...
```console
make deploy IMG=ghcr.io/stackzoo/khaos:0.0.21
```  
...
```console
cosign verify --key cosign/cosign.pub ghcr.io/stackzoo/khaos:0.0.21
```  
Verification output:  
```console

Verification for ghcr.io/stackzoo/khaos:0.0.21 --
